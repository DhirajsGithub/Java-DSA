...
public class Main {
    ...
    static void BI() {
        ...
        BigInteger C = new BigInteger("2345678654325678976543256789");      // if number is big then need to pass it in string
        BigInteger X = new BigInteger("4536789765432");

        // constants
        BigInteger D = BigInteger.TEN;      // 10
        System.out.println(D);

        // operations
        BigInteger s = C.add(X);        // can't do C + X
