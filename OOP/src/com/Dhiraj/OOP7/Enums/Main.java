package com.Dhiraj.OOP7.Enums;

import java.util.Arrays;

public class Main {
    enum Week implements A{
        // enum can implements as many interface it can, but cannot extend any class
        ...
        // whye ? coz we don't want to create new object, coz this is not the enum concept
        Week(){
            System.out.println("Constructor called for "+this);
        }

        // constructor, access one will call for all enum constant
        void week(){
            System.out.println("Constructor called for "+ this);
        }

        // abstracts are not allowed in enum
//        void display();
        void display(){
        ...
        @Override
        public void hello() {
            System.out.println("Hey, Jytoi seems very beautiful");
        }
        // this is not public or protected, only private and default
        // why ? as enum defination we don't want to create new object
