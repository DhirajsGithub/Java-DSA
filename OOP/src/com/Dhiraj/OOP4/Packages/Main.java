package com.Dhiraj.OOP4.Packages;
...
In-built
lang  --> (mandatory stuff like primitves, opertaions stuff, all basic stuff)  java.lang is automatically imported
io  --> contains input output stuff
util  --> utility classes (Data Structure and stuff)
applet  --> development side
awt  --> GUI application ans stuff
net  --> connect to the net while making app
